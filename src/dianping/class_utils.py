...
class ClassDict(object):
    ...
    def get_by_location(self, x, y, step=None):
        x = np.abs(x)
...
if __name__ == '__main__':
    # cd = get_text_dictsvg_ClassDict()
    # # result = cd.get_by_location_str("-523.0px -42.0px")
    # result = cd.get_by_location_str("-55.0px -81.0px")

    cd = get_svg_ClassDict(
        data_path="/Users/huang/Desktop/workpython/jayin-python-app/src/dianping/svgs/8d68e9460712aff87ea15eee62fe41ca.svg")
    result = cd.get_by_location_str("-154.0px -581.0px")
    print("result", result)
