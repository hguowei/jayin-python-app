...
def _get_ymd_from_date_string(date):
...
_end_string = _get_ymd_from_date_string(now_date)


def get_data(code, start_date_string, end_date_string, ktype="D"):
    print("get_data(", start_date_string, ", ", end_date_string, ")")
    if isinstance(start_date_string, datetime):
        start_date_string = _get_ymd_from_date_string(start_date_string)
    if isinstance(end_date_string, datetime):
        end_date_string = _get_ymd_from_date_string(end_date_string)
...
def get_his_data(code, start_string="2018-01-01"):
    ...
    query_data = get_data(code, start_string, _end_string)
